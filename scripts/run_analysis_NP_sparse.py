...
if __name__ == "__main__":
    ...
    print("Using sparse jacobian") #default
    ...
    def run(model,n_z,orbit_method):
        ...
        filename = f"{Dir_path/orbit_method}_nz_{n_z}_sparse.prof"
    ...
    checkpoint_file = f'{Dir_path}/checkpoint_NP_sparse.txt'
    batch_size = 1
    inputs = dim_nz
    ...
    print("Runing method: Newton-Picard with sparse Jac.........\n")
    all_results = []
    ...
    #Saving the results
    file_path = f"{Dir_path/orbit_method}_sparse.txt"
