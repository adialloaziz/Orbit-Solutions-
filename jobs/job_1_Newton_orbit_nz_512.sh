#!/bin/bash 
#PBS -S /bin/bash
#PBS -N 1_run_sparse_Newton_orbit_512
#PBS -M diallo
...
#PBS -m bea
#PBS -o logs/1_Newton_orbit_sparse_nz_512_rerun1.out
#PBS -e logs/1_Newton_orbit_sparse_nz_512_rerun1.err
#PBS -V
#PBS -q plong
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=notfull_subiter_bruss.in -n_z=512 -method=Newton_orbit -sparse_jac -p0=5
