#!/bin/bash 
#PBS -S /bin/bash
#PBS -N 2_run_sparse_Newton_orbit_16
#PBS -M diallo
...
#PBS -m bea
#PBS -o logs/2_Newton_orbit_sparse_nz_16_rerun1.out
#PBS -e logs/2_Newton_orbit_sparse_nz_16_rerun1.err
#PBS -V
#PBS -q plong
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=p_equal_2nz_bruss.in -n_z=16 -method=Newton_orbit -sparse_jac -p0=30
