...
#PBS -m bea
#PBS -o logs/BDF/0_Newton_orbit_sparse_nz_16_rerun1.out
#PBS -e logs/BDF/0_Newton_orbit_sparse_nz_16_rerun1.err
#PBS -V
#PBS -q plong
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=BDF_bruss_dflt_params.in -n_z=16 -method=Newton_orbit -sparse_jac -p0=5
