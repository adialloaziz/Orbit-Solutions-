...
#PBS -m bea
#PBS -o logs/RK45/2_Newton_Picard_sub_proj_sparse_nz_32.out
#PBS -e logs/RK45/2_Newton_Picard_sub_proj_sparse_nz_32.err
#PBS -V
#PBS -q plong
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=RK45_p_equal_2nz_bruss.in -n_z=32 -method=Newton_Picard_sub_proj -sparse_jac -p0=62
