...
#PBS -m bea
#PBS -o logs/RK45/0_Newton_Picard_sub_proj_sparse_nz_512.out
#PBS -e logs/RK45/0_Newton_Picard_sub_proj_sparse_nz_512.err
#PBS -V
#PBS -q plong
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=RK45_bruss_dflt_params.in -n_z=512 -method=Newton_Picard_sub_proj -sparse_jac -p0=5
