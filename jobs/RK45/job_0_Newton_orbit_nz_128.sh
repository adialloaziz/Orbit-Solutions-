...
#PBS -m bea
#PBS -o logs/RK45/0_Newton_orbit_sparse_nz_128.out
#PBS -e logs/RK45/0_Newton_orbit_sparse_nz_128.err
#PBS -V
#PBS -q plong
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=RK45_bruss_dflt_params.in -n_z=128 -method=Newton_orbit -sparse_jac -p0=5
