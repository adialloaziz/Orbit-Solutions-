#!/bin/bash 
#PBS -S /bin/bash
#PBS -N 0_run_sparse_Newton_orbit_10
#PBS -M diallo
...
#PBS -m bea
#PBS -o logs/0_Newton_orbit_sparse_nz_10_rerun.out
#PBS -e logs/0_Newton_orbit_sparse_nz_10_rerun.err
#PBS -V
#PBS -q short
cd /home/diallo/Orbit-Solutions-
/home/diallo/Orbit-Solutions-/.myvenv/bin/python3 /home/diallo/Orbit-Solutions-/run_analysis.py -param_file=bruss_dflt_params.in -n_z=10 -method=Newton_orbit -sparse_jac -p0=5
