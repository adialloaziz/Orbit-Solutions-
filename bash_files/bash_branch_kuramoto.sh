...
cat > jobs/branch_kuramoto/job_branch_kuramoto.sh <<EOF
...
qsub jobs/branch_kuramoto/job_branch_kuramoto.sh
echo "Submitted job script: branch_kuramoto/job_branch_kuramoto.sh"	
